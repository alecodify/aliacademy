  ...
  return (
    <div className="min-h-screen py-10 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-8 mb-8 text-white shadow-xl">
          <div className="flex items-center justify-between flex-wrap gap-6">
            <div>
              <h1 className="text3xl md:text-4xl font-bold">📚 Notes Management</h1>

              <p className="mt-2 text-slate-300 text-sm md:text-lg">
                Upload, update and delete study notes for every class.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8">
          ...
          {activeTab === "upload" && (
            <>
              <h2 className="text2xl md:text-3xl font-bold text-slate-800 mb-2 text-center">
                Upload New Notes
              </h2>
